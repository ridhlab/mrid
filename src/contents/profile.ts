...
export const Profile = {
    ...
    shortBio:
        "I'm Ridwan, Over 3+ years experience. Have passionate in Software Development and programming. Currently focused on Fulltack Development. Love to explore new things related on Technology, Software Engineering, Artificial Intelligence and many more then connect them to discover useful insights.",
    socialLinks: {
